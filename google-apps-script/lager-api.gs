...
const KATALOG_START_ROWS = [
  ...
  [16, "konsolen", "gba-gengar", "Game Boy Advance Gengar Edition", "assets/products/Gameboy/gba-gengar-float.png", "konsolen gba ausverkauft", "", "Custom Gengar Design – transluzent|Neues Austauschgehäuse & frische Display-Scheibe|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [17, "konsolen", "gba-charmander", "Game Boy Advance Glumanda Edition", "assets/products/Gameboy/gba-charmander-float.png", "konsolen gba ausverkauft", "", "Custom Glumanda Design – transluzent orange|Neues Austauschgehäuse & frische Display-Scheibe|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [18, "konsolen", "gbasp-pokemon-g", "Game Boy Advance SP Pokémon Groudon Edition", "assets/products/Gameboy/GBASP_G_float.png", "konsolen gbasp", "", "Frisches Groudon-Austauschgehäuse – top Zustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [19, "konsolen", "gbasp-pokemon-k", "Game Boy Advance SP Pokémon Kyogre Edition", "assets/products/Gameboy/GBASP_K_float.png", "konsolen gbasp", "", "Frisches Kyogre-Austauschgehäuse – top Zustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [20, "konsolen", "gbasp-pokemon-r", "Game Boy Advance SP Pokémon Rayquaza Edition", "assets/products/Gameboy/GBASP_R_float.png", "konsolen gbasp", "", "Frisches Rayquaza-Austauschgehäuse – top Zustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [21, "konsolen", "gbasp-blau", "Game Boy Advance SP Blau", "assets/products/Gameboy/GBASP_blau_float.png", "konsolen gbasp", "", "Original Nintendo-Gehäuse · guter Gebrauchtzustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [22, "konsolen", "gbasp-schwarz", "Game Boy Advance SP Schwarz", "assets/products/Gameboy/GBASP_black_float.png", "konsolen gbasp", "", "Original Nintendo-Gehäuse · guter Gebrauchtzustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [23, "konsolen", "gbasp-silber", "Game Boy Advance SP Silber", "assets/products/Gameboy/GBASP_silber_float.png", "konsolen gbasp", "", "Original Nintendo-Gehäuse · guter Gebrauchtzustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [24, "konsolen", "gbasp-mario", "Game Boy Advance SP Mario Edition", "assets/products/Gameboy/GBASP_mario_float.png", "konsolen gbasp", "", "Original Nintendo-Gehäuse · guter Gebrauchtzustand|AGS-001 Original-Display|USB-Ladekabel inklusive|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", ""],
  [25, "konsolen", "ps2-slim-ovp", "SONY PS2 PlayStation 2 Slim Konsole in OVP + 2 Controller Memory Card", "assets/products/Weitere/PS2_SLIM_OVP.jpeg", "konsolen weitere ps2", "", "PlayStation 2 Slim in Originalverpackung (OVP)|2× original DualShock 2 Controller|Memory Card im Lieferumfang|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja", 2004],
  [26, "spiel", "t", "Tetris", "assets/products/Games/T_Z3.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Wartungsfrei – keine Speicherbatterie nötig|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "T", "z2:jpeg|z3:jpeg", "ja", 1990],
  [27, "spiel", "sm1", "Super Mario Land", "assets/products/Games/SM1_Z3.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Wartungsfrei – keine Speicherbatterie nötig|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "SM1", "z1:webp|z2:webp|z3:webp", "ja", 1990],
  [28, "spiel", "sm2", "Super Mario Land 2", "assets/products/Games/SM2_Z4.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "SM2", "z1:jpeg|z3:webp|z4:webp", "ja", 1992],
  [29, "spiel", "zla", "Zelda: Link's Awakening", "assets/products/Games/ZLA_Z3.jpg", "spiele spiel-variante", "Zelda", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "ZLA", "z2:jpeg|z3:jpg", "ja", 1993],
  [30, "spiel", "sm3", "Super Mario Land 3", "assets/products/Games/SM3_Z4.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "SM3", "z1:webp|z2:webp|z3:webp|z4:webp", "ja", 1994],
  [31, "spiel", "pb", "Pokémon Blau", "assets/products/Games/PB_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PB", "z2:jpeg|z3:jpeg|z4:jpeg", "ja", 1998],
  [32, "spiel", "pr", "Pokémon Rot", "assets/products/Games/PR_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PR", "z1:jpeg|z2:jpeg|z3:jpeg", "ja", 1998],
  [33, "spiel", "pg", "Pokémon Gelb", "assets/products/Games/PG_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PG", "z2:jpeg|z3:jpeg|z4:jpeg", "ja", 1999],
  [34, "spiel", "pt", "Pokémon Trading Card", "assets/products/Games/PT_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PT", "z3:jpeg", "ja", 2000],
  [35, "spiel", "pgo", "Pokémon Gold", "assets/products/Games/PGO_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PGO", "z2:jpeg|z3:jpeg", "ja", 2000],
  [36, "spiel", "psi", "Pokémon Silber", "assets/products/Games/PSI_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSI", "z1:jpeg|z2:jpeg|z3:jpeg", "ja", 2000],
  [37, "spiel", "pk", "Pokémon Kristall", "assets/products/Games/PK_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PK", "z2:jpeg|z3:jpeg|z4:jpeg", "ja", 2001],
  [38, "spiel", "dbz", "Dragon Ball Z", "assets/products/Games/DBZ_Z3.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "DBZ", "z3:jpeg", "ja", 2002],
  [39, "spiel", "pre", "Pokémon Rubin-Edition", "assets/products/Games/PRE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PRE", "z3:jpeg", "ja", 2003],
  [40, "spiel", "pse", "Pokémon Saphir-Edition", "assets/products/Games/PSE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSE", "z3:jpeg", "ja", 2003],
  [41, "spiel", "pfe", "Pokémon Feuerrote Edition", "assets/products/Games/PFE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PFE", "z3:jpeg", "ja", 2004],
  [42, "spiel", "pbe", "Pokémon Blattgrüne Edition", "assets/products/Games/PBE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PBE", "z3:jpeg", "ja", 2004]
];

...
const KATALOG_START_ROWS = [
  ...
  [25, "spiel", "t", "Tetris", "assets/products/Games/T_Z3.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Wartungsfrei – keine Speicherbatterie nötig|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "T", "z2:jpeg|z3:jpeg", "ja"],
  [26, "spiel", "sm1", "Super Mario Land", "assets/products/Games/SM1_Z3.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Wartungsfrei – keine Speicherbatterie nötig|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "SM1", "z1:webp|z2:webp|z3:webp", "ja"],
  [27, "spiel", "sm2", "Super Mario Land 2", "assets/products/Games/SM2_Z4.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "SM2", "z1:jpeg|z3:webp|z4:webp", "ja"],
  [28, "spiel", "zla", "Zelda: Link's Awakening", "assets/products/Games/ZLA_Z3.jpg", "spiele spiel-variante", "Zelda", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "ZLA", "z2:jpeg|z3:jpg", "ja"],
  [29, "spiel", "sm3", "Super Mario Land 3", "assets/products/Games/SM3_Z4.webp", "spiele spiel-variante", "Mario", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "SM3", "z1:webp|z2:webp|z3:webp|z4:webp", "ja"],
  [30, "spiel", "pb", "Pokémon Blau", "assets/products/Games/PB_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PB", "z2:jpeg|z3:jpeg|z4:jpeg", "ja"],
  [31, "spiel", "pr", "Pokémon Rot", "assets/products/Games/PR_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PR", "z1:jpeg|z2:jpeg|z3:jpeg", "ja"],
  [32, "spiel", "pg", "Pokémon Gelb", "assets/products/Games/PG_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PG", "z2:jpeg|z3:jpeg|z4:jpeg", "ja"],
  [33, "spiel", "pt", "Pokémon Trading Card", "assets/products/Games/PT_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PT", "z3:jpeg", "ja"],
  [34, "spiel", "pgo", "Pokémon Gold", "assets/products/Games/PGO_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PGO", "z2:jpeg|z3:jpeg", "ja"],
  [35, "spiel", "psi", "Pokémon Silber", "assets/products/Games/PSI_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSI", "z1:jpeg|z2:jpeg|z3:jpeg", "ja"],
  [36, "spiel", "pk", "Pokémon Kristall", "assets/products/Games/PK_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PK", "z2:jpeg|z3:jpeg|z4:jpeg", "ja"],
  [37, "spiel", "pre", "Pokémon Rubin-Edition", "assets/products/Games/PRE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PRE", "z3:jpeg", "ja"],
  [38, "spiel", "pse", "Pokémon Saphir-Edition", "assets/products/Games/PSE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSE", "z3:jpeg", "ja"],
  [39, "spiel", "dbz", "Dragon Ball Z", "assets/products/Games/DBZ_Z3.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "DBZ", "z3:jpeg", "ja"],
  [40, "spiel", "pfe", "Pokémon Feuerrote Edition", "assets/products/Games/PFE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PFE", "z3:jpeg", "ja"],

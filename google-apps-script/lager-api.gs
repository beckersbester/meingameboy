...
const KATALOG_START_ROWS = [
  ...
  [16, "konsolen", "gba-gengar", "Game Boy Advance Gengar Edition", "assets/products/gba-gengar-float.png", "konsolen gba ausverkauft", "", "Custom Gengar Design – transluzent|Neues Austauschgehäuse & frische Display-Scheibe|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja"],
  [17, "konsolen", "gba-charmander", "Game Boy Advance Glumanda Edition", "assets/products/gba-charmander-float.png", "konsolen gba ausverkauft", "", "Custom Glumanda Design – transluzent orange|Neues Austauschgehäuse & frische Display-Scheibe|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "", "", "", "ja"],
  ...
  [28, "spiel", "pb", "Pokémon Blau", "assets/products/PB_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PB", "z2:jpeg|z3:jpeg|z4:jpeg", "ja"],
  [29, "spiel", "pr", "Pokémon Rot", "assets/products/PR_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PR", "z1:jpeg|z2:jpeg|z3:jpeg", "ja"],
  [30, "spiel", "pg", "Pokémon Gelb", "assets/products/PG_Z4.webp", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PG", "z2:webp|z3:webp|z4:webp", "ja"],
  [31, "spiel", "pgo", "Pokémon Gold", "assets/products/PGO_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PGO", "z2:jpeg|z3:jpeg", "ja"],
  [32, "spiel", "psi", "Pokémon Silber", "assets/products/PSI_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSI", "z1:jpeg|z2:jpeg|z3:jpeg", "ja"],
  [33, "spiel", "pk", "Pokémon Kristall", "assets/products/PK_Z4.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z4", "PK", "z2:jpeg|z3:jpeg|z4:jpeg", "ja"],
  [34, "spiel", "pt", "Pokémon Trading Card", "assets/products/PT_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PT", "z3:jpeg", "ja"],
  [35, "spiel", "dbz", "Dragon Ball Z", "assets/products/DBZ_Z3.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "DBZ", "z3:jpeg", "ja"],
  [36, "spiel", "zla", "Zelda: Link's Awakening", "assets/products/ZLA_Z2.jpeg", "spiele spiel-variante", "Zelda", "Original Game Boy Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z2", "ZLA", "z2:jpeg|z3:jpg", "ja"],
  [37, "spiel", "t", "Tetris", "assets/products/T_Z2.jpeg", "spiele spiel-variante", "Klassiker", "Original Game Boy Modul|Wartungsfrei – keine Speicherbatterie nötig|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z2", "T", "z2:jpeg|z3:jpeg", "ja"],
  [38, "spiel", "pfe", "Pokémon Feuerrote Edition", "assets/products/PFE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PFE", "z3:jpeg", "ja"],
  [39, "spiel", "pse", "Pokémon Saphir-Edition", "assets/products/PSE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PSE", "z3:jpeg", "ja"],
  [40, "spiel", "pre", "Pokémon Rubin-Edition", "assets/products/PRE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PRE", "z3:jpeg", "ja"],
  [41, "spiel", "pbe", "Pokémon Blattgrüne Edition", "assets/products/PBE_Z3.jpeg", "spiele spiel-variante", "Pokémon", "Original Game Boy Advance Modul|Speichert (neue Batterie)|Technisch geprüft · sofort spielbereit|Kostenloser Versand", "z3", "PBE", "z3:jpeg", "ja"]
];
